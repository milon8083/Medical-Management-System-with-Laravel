    ...
    <div class="container">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="widget widget-contact mb-5 mb-lg-0">
                    ...
                    <div class="footer-contact-block mb-4">
                        ...
                        <h4 class="mt-2"><a href="tel:+23-345-67890">milonSupport@gmail.com</a></h4>
                    </div>
                    ...
                    <div class="footer-contact-block">
                        ...
                        <h4 class="mt-2"><a href="tel:+23-345-67890">+8801994885302</a></h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="footer-btm py-4 mt-5">
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-6">
                    <div class="copyright">
                        &copy; Copyright Reserved to <span class="text-color">Milon</span>
                    </div>
                </div>
                <div class="col-lg-6">
